...
class DrawingFullError(Exception):
    """Print that the drawing is full."""
...
class FigureDoesNotExistError(Exception):
    """Print that the figure does not exist."""
...
class DrawingCanvas:
    ...
    def __init__(self, max_figures: int, author: str, figures=None):
        """
